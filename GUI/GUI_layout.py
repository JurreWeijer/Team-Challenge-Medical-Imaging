...
class GUI_Layout:
    ...
    def landmark_extension_buttons(self):
        ...
        self.master.compute_rib_rotation = customtkinter.CTkButton(self.master.button_frame, text = "compute rib rotation", font = ("Arial",18), )
        self.master.compute_rib_rotation.grid(row=10, column = 1, columnspan = 1, padx=(5,5), pady=(5,5), sticky = 'ew')
